...
sudo yum install libass-devel freetype-devel SDL-devel libtheora-devel libtool libva-devel libvdpau-devel libvorbis-devel libxcb-devel texinfo zlib-devel wget which
